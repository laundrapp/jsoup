...
//  source: /Users/marcussmith/temp/jsoup/src/main/java/org/jsoup/parser/ParseErrorList.java
//
...
OrgJsoupParserParseErrorList *OrgJsoupParserParseErrorList_noTracking() {
  ...
  return create_OrgJsoupParserParseErrorList_initWithInt_withInt_(0, 0);
}

OrgJsoupParserParseErrorList *OrgJsoupParserParseErrorList_trackingWithInt_(jint maxSize) {
  OrgJsoupParserParseErrorList_initialize();
  return create_OrgJsoupParserParseErrorList_initWithInt_withInt_(OrgJsoupParserParseErrorList_INITIAL_CAPACITY, maxSize);
}
