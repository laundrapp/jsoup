...
+ (void)initialize {
  if (self == [OrgJsoupParserTag class]) {
    JreStrongAssignAndConsume(&OrgJsoupParserTag_tags, new_JavaUtilHashMap_init());
    JreStrongAssignAndConsume(&OrgJsoupParserTag_blockTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"html", @"head", @"body", @"frameset", @"script", @"noscript", @"style", @"meta", @"link", @"title", @"frame", @"noframes", @"section", @"nav", @"aside", @"hgroup", @"header", @"footer", @"p", @"h1", @"h2", @"h3", @"h4", @"h5", @"h6", @"ul", @"ol", @"pre", @"div", @"blockquote", @"hr", @"address", @"figure", @"figcaption", @"form", @"fieldset", @"ins", @"del", @"s", @"dl", @"dt", @"dd", @"li", @"table", @"caption", @"thead", @"tfoot", @"tbody", @"colgroup", @"col", @"tr", @"th", @"td", @"video", @"audio", @"canvas", @"details", @"menu", @"plaintext", @"template", @"article", @"main", @"svg", @"math" } count:64 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_inlineTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"object", @"base", @"font", @"tt", @"i", @"b", @"u", @"big", @"small", @"em", @"strong", @"dfn", @"code", @"samp", @"kbd", @"var", @"cite", @"abbr", @"time", @"acronym", @"mark", @"ruby", @"rt", @"rp", @"a", @"img", @"br", @"wbr", @"map", @"q", @"sub", @"sup", @"bdo", @"iframe", @"embed", @"span", @"input", @"select", @"textarea", @"label", @"button", @"optgroup", @"option", @"legend", @"datalist", @"keygen", @"output", @"progress", @"meter", @"area", @"param", @"source", @"track", @"summary", @"command", @"device", @"area", @"basefont", @"bgsound", @"menuitem", @"param", @"source", @"track", @"data", @"bdi" } count:65 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_emptyTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"meta", @"link", @"base", @"frame", @"img", @"br", @"wbr", @"embed", @"hr", @"input", @"keygen", @"col", @"command", @"device", @"area", @"basefont", @"bgsound", @"menuitem", @"param", @"source", @"track" } count:21 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_formatAsInlineTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"title", @"a", @"p", @"h1", @"h2", @"h3", @"h4", @"h5", @"h6", @"pre", @"address", @"li", @"th", @"td", @"script", @"style", @"ins", @"del", @"s" } count:19 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_preserveWhitespaceTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"pre", @"plaintext", @"title", @"textarea" } count:4 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_formListedTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"button", @"fieldset", @"input", @"keygen", @"object", @"output", @"select", @"textarea" } count:8 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgJsoupParserTag_formSubmitTags, [IOSObjectArray newArrayWithObjects:(id[]){ @"input", @"keygen", @"object", @"select", @"textarea" } count:5 type:NSString_class_()]);
    {
      {
        ...
        while (b__ < e__) {
          ...
          OrgJsoupParserTag *tag = create_OrgJsoupParserTag_initWithNSString_(tagName);
          OrgJsoupParserTag_register__WithOrgJsoupParserTag_(tag);
        }
      }
      {
...
void OrgJsoupParserTag_initWithNSString_(OrgJsoupParserTag *self, NSString *tagName) {
  ...
  JreStrongAssign(&self->tagName_, [((NSString *) nil_chk(tagName)) lowercaseString]);
}
...
OrgJsoupParserTag *OrgJsoupParserTag_valueOfWithNSString_(NSString *tagName) {
  ...
  if (tag == nil) {
    ...
    if (tag == nil) {
      tag = create_OrgJsoupParserTag_initWithNSString_(tagName);
      tag->isBlock_ = false;
...
void OrgJsoupParserTag_register__WithOrgJsoupParserTag_(OrgJsoupParserTag *tag) {
  OrgJsoupParserTag_initialize();
  [((id<JavaUtilMap>) nil_chk(OrgJsoupParserTag_tags)) putWithId:((OrgJsoupParserTag *) nil_chk(tag))->tagName_ withId:tag];
}
