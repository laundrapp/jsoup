...
//  source: /Users/marcussmith/temp/jsoup/src/main/java/org/jsoup/parser/Token.java
//
...
- (void)dealloc {
  RELEASE_(name_);
  RELEASE_(publicIdentifier_);
  RELEASE_(systemIdentifier_);
  [super dealloc];
}
...
void OrgJsoupParserToken_Doctype_init(OrgJsoupParserToken_Doctype *self) {
  OrgJsoupParserToken_init(self);
  JreStrongAssignAndConsume(&self->name_, new_JavaLangStringBuilder_init());
  JreStrongAssignAndConsume(&self->publicIdentifier_, new_JavaLangStringBuilder_init());
  JreStrongAssignAndConsume(&self->systemIdentifier_, new_JavaLangStringBuilder_init());
  self->forceQuirks_ = false;
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, Doctype));
}
...
- (void)appendAttributeValueWithNSString:(NSString *)append {
  ...
  [((JavaLangStringBuilder *) nil_chk(pendingAttributeValue_)) appendWithNSString:append];
}

- (void)appendAttributeValueWithChar:(jchar)append {
  OrgJsoupParserToken_Tag_ensureAttributeValue(self);
  [((JavaLangStringBuilder *) nil_chk(pendingAttributeValue_)) appendWithChar:append];
}

- (void)appendAttributeValueWithCharArray:(IOSCharArray *)append {
  OrgJsoupParserToken_Tag_ensureAttributeValue(self);
  [((JavaLangStringBuilder *) nil_chk(pendingAttributeValue_)) appendWithCharArray:append];
}
...
- (void)dealloc {
  RELEASE_(tagName_);
  RELEASE_(pendingAttributeName_);
  RELEASE_(pendingAttributeValue_);
...
void OrgJsoupParserToken_Tag_init(OrgJsoupParserToken_Tag *self) {
  OrgJsoupParserToken_init(self);
  JreStrongAssignAndConsume(&self->pendingAttributeValue_, new_JavaLangStringBuilder_init());
...
OrgJsoupParserToken_Tag *OrgJsoupParserToken_Tag_reset(OrgJsoupParserToken_Tag *self) {
  JreStrongAssign(&self->tagName_, nil);
  JreStrongAssign(&self->pendingAttributeName_, nil);
...
void OrgJsoupParserToken_Tag_newAttribute(OrgJsoupParserToken_Tag *self) {
  if (self->attributes_ == nil) JreStrongAssignAndConsume(&self->attributes_, new_OrgJsoupNodesAttributes_init());
  if (self->pendingAttributeName_ != nil) {
    OrgJsoupNodesAttribute *attribute;
    if (self->hasPendingAttributeValue_) attribute = create_OrgJsoupNodesAttribute_initWithNSString_withNSString_(self->pendingAttributeName_, [((JavaLangStringBuilder *) nil_chk(self->pendingAttributeValue_)) description]);
    else if (self->hasEmptyAttributeValue_) attribute = create_OrgJsoupNodesAttribute_initWithNSString_withNSString_(self->pendingAttributeName_, @"");
    else attribute = create_OrgJsoupNodesBooleanAttribute_initWithNSString_(self->pendingAttributeName_);
...
void OrgJsoupParserToken_Tag_appendTagNameWithNSString_(OrgJsoupParserToken_Tag *self, NSString *append) {
  JreStrongAssign(&self->tagName_, self->tagName_ == nil ? append : [self->tagName_ java_concat:append]);
}

void OrgJsoupParserToken_Tag_appendAttributeNameWithNSString_(OrgJsoupParserToken_Tag *self, NSString *append) {
  JreStrongAssign(&self->pendingAttributeName_, self->pendingAttributeName_ == nil ? append : [self->pendingAttributeName_ java_concat:append]);
}
...
- (OrgJsoupParserToken_Tag *)reset {
  OrgJsoupParserToken_Tag_reset(self);
  JreStrongAssignAndConsume(&attributes_, new_OrgJsoupNodesAttributes_init());
  return self;
}
...
- (OrgJsoupParserToken_StartTag *)nameAttrWithNSString:(NSString *)name
  ...
  JreStrongAssign(&self->tagName_, name);
...
void OrgJsoupParserToken_StartTag_init(OrgJsoupParserToken_StartTag *self) {
  ...
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, StartTag));
}
...
void OrgJsoupParserToken_EndTag_init(OrgJsoupParserToken_EndTag *self) {
  OrgJsoupParserToken_Tag_init(self);
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, EndTag));
}
...
void OrgJsoupParserToken_Comment_init(OrgJsoupParserToken_Comment *self) {
  OrgJsoupParserToken_init(self);
  JreStrongAssignAndConsume(&self->data_, new_JavaLangStringBuilder_init());
  self->bogus_ = false;
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, Comment));
}
...
void OrgJsoupParserToken_Character_init(OrgJsoupParserToken_Character *self) {
  OrgJsoupParserToken_init(self);
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, Character));
}
...
void OrgJsoupParserToken_EOF_init(OrgJsoupParserToken_EOF *self) {
  OrgJsoupParserToken_init(self);
  JreStrongAssign(&self->type_, JreLoadEnum(OrgJsoupParserToken_TokenType, EOF));
}
