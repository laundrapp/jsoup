...
- (void)outerHtmlHeadWithJavaLangStringBuilder:(JavaLangStringBuilder *)accum
  ...
  if ([((OrgJsoupNodesDocument_OutputSettings *) nil_chk(outArg)) syntax] == JreLoadEnum(OrgJsoupNodesDocument_OutputSettings_Syntax, html) && !OrgJsoupNodesDocumentType_hasWithNSString_(self, OrgJsoupNodesDocumentType_PUBLIC_ID) && !OrgJsoupNodesDocumentType_hasWithNSString_(self, OrgJsoupNodesDocumentType_SYSTEM_ID)) {
    [((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:@"<!doctype"];
  }
  else {
    [((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:@"<!DOCTYPE"];
  }
  if (OrgJsoupNodesDocumentType_hasWithNSString_(self, OrgJsoupNodesDocumentType_NAME)) [((JavaLangStringBuilder *) nil_chk([accum appendWithNSString:@" "])) appendWithNSString:[self attrWithNSString:OrgJsoupNodesDocumentType_NAME]];
  if (OrgJsoupNodesDocumentType_hasWithNSString_(self, OrgJsoupNodesDocumentType_PUBLIC_ID)) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([accum appendWithNSString:@" PUBLIC \""])) appendWithNSString:[self attrWithNSString:OrgJsoupNodesDocumentType_PUBLIC_ID]])) appendWithChar:'"'];
  if (OrgJsoupNodesDocumentType_hasWithNSString_(self, OrgJsoupNodesDocumentType_SYSTEM_ID)) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([accum appendWithNSString:@" \""])) appendWithNSString:[self attrWithNSString:OrgJsoupNodesDocumentType_SYSTEM_ID]])) appendWithChar:'"'];
...
void OrgJsoupNodesDocumentType_initWithNSString_withNSString_withNSString_withNSString_(OrgJsoupNodesDocumentType *self, NSString *name, NSString *publicId, NSString *systemId, NSString *baseUri) {
  ...
  [self attrWithNSString:OrgJsoupNodesDocumentType_NAME withNSString:name];
  [self attrWithNSString:OrgJsoupNodesDocumentType_PUBLIC_ID withNSString:publicId];
  [self attrWithNSString:OrgJsoupNodesDocumentType_SYSTEM_ID withNSString:systemId];
}
