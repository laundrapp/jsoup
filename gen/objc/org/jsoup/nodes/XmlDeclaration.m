...
- (NSString *)getWholeDeclaration {
  ...
  if ([((NSString *) nil_chk(decl)) isEqual:@"xml"] && [((OrgJsoupNodesAttributes *) nil_chk(attributes_)) size] > 1) {
    JavaLangStringBuilder *sb = create_JavaLangStringBuilder_initWithNSString_(decl);
    NSString *version_ = [((OrgJsoupNodesAttributes *) nil_chk(attributes_)) getWithNSString:@"version"];
    if (version_ != nil) {
      [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@" version=\""])) appendWithNSString:version_])) appendWithNSString:@"\""];
    }
    NSString *encoding = [((OrgJsoupNodesAttributes *) nil_chk(attributes_)) getWithNSString:@"encoding"];
    if (encoding != nil) {
      [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@" encoding=\""])) appendWithNSString:encoding])) appendWithNSString:@"\""];
    }
...
- (void)outerHtmlHeadWithJavaLangStringBuilder:(JavaLangStringBuilder *)accum
  ...
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:@"<"])) appendWithNSString:isProcessingInstruction_ ? @"!" : @"?"])) appendWithNSString:[self getWholeDeclaration]])) appendWithNSString:@">"];
}
