...
- (void)setBaseUriWithNSString:(NSString *)baseUri {
  ...
  [self traverseWithOrgJsoupSelectNodeVisitor:create_OrgJsoupNodesNode_1_initWithNSString_(baseUri)];
}
...
- (id<JavaUtilList>)childNodesCopy {
  id<JavaUtilList> children = create_JavaUtilArrayList_initWithInt_([((id<JavaUtilList>) nil_chk(childNodes_)) size]);
...
- (IOSObjectArray *)childNodesAsArray {
  return [((id<JavaUtilList>) nil_chk(childNodes_)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:OrgJsoupNodesNode_childNodeSize(self) type:OrgJsoupNodesNode_class_()]];
}
...
- (OrgJsoupNodesNode *)beforeWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)node {
  ...
  OrgJsoupHelperValidate_notNullWithId_(parentNode_);
  [((OrgJsoupNodesNode *) nil_chk(parentNode_)) addChildrenWithInt:siblingIndex_ withOrgJsoupNodesNodeArray:[IOSObjectArray arrayWithObjects:(id[]){ node } count:1 type:OrgJsoupNodesNode_class_()]];
  return self;
}
...
- (OrgJsoupNodesNode *)afterWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)node {
  OrgJsoupHelperValidate_notNullWithId_(node);
  OrgJsoupHelperValidate_notNullWithId_(parentNode_);
  [((OrgJsoupNodesNode *) nil_chk(parentNode_)) addChildrenWithInt:siblingIndex_ + 1 withOrgJsoupNodesNodeArray:[IOSObjectArray arrayWithObjects:(id[]){ node } count:1 type:OrgJsoupNodesNode_class_()]];
  return self;
}
...
- (OrgJsoupNodesNode *)wrapWithNSString:(NSString *)html {
  ...
  [((OrgJsoupNodesElement *) nil_chk(deepest)) addChildrenWithOrgJsoupNodesNodeArray:[IOSObjectArray arrayWithObjects:(id[]){ self } count:1 type:OrgJsoupNodesNode_class_()]];
  if ([wrapChildren size] > 0) {
    for (jint i = 0; i < [wrapChildren size]; i++) {
      ...
      [wrap appendChildWithOrgJsoupNodesNode:remainder];
    }
  }
  return self;
}
...
- (void)setParentNodeWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)parentNode {
  ...
  JreStrongAssign(&self->parentNode_, parentNode);
}
...
- (void)replaceChildWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)outArg
  ...
  [((id<JavaUtilList>) nil_chk(childNodes_)) setWithInt:index withId:inArg];
  JreStrongAssign(&inArg->parentNode_, self);
  [inArg setSiblingIndexWithInt:index];
  JreStrongAssign(&outArg->parentNode_, nil);
}

- (void)removeChildWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)outArg {
  OrgJsoupHelperValidate_isTrueWithBoolean_(((OrgJsoupNodesNode *) nil_chk(outArg))->parentNode_ == self);
  jint index = outArg->siblingIndex_;
  [((id<JavaUtilList>) nil_chk(childNodes_)) removeWithInt:index];
...
- (void)ensureChildNodes {
  if (childNodes_ == OrgJsoupNodesNode_EMPTY_NODES) {
    JreStrongAssignAndConsume(&childNodes_, new_JavaUtilArrayList_initWithInt_(4));
  }
}
...
- (id<JavaUtilList>)siblingNodes {
  ...
  id<JavaUtilList> siblings = create_JavaUtilArrayList_initWithInt_([((id<JavaUtilList>) nil_chk(nodes)) size] - 1);
...
- (NSString *)outerHtml {
  JavaLangStringBuilder *accum = create_JavaLangStringBuilder_initWithInt_(128);
...
- (void)outerHtmlWithJavaLangStringBuilder:(JavaLangStringBuilder *)accum {
  [create_OrgJsoupSelectNodeTraversor_initWithOrgJsoupSelectNodeVisitor_(create_OrgJsoupNodesNode_OuterHtmlVisitor_initWithJavaLangStringBuilder_withOrgJsoupNodesDocument_OutputSettings_(accum, [self getOutputSettings])) traverseWithOrgJsoupNodesNode:self];
}

- (OrgJsoupNodesDocument_OutputSettings *)getOutputSettings {
  return [self ownerDocument] != nil ? [((OrgJsoupNodesDocument *) nil_chk([self ownerDocument])) outputSettings] : [(create_OrgJsoupNodesDocument_initWithNSString_(@"")) outputSettings];
}
...
- (OrgJsoupNodesNode *)java_clone {
  ...
  JavaUtilLinkedList *nodesToProcess = create_JavaUtilLinkedList_init();
  ...
  while (![nodesToProcess isEmpty]) {
    ...
    for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(((OrgJsoupNodesNode *) nil_chk(currParent))->childNodes_)) size]; i++) {
      ...
      [((id<JavaUtilList>) nil_chk(currParent->childNodes_)) setWithInt:i withId:childClone];
...
- (OrgJsoupNodesNode *)doCloneWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)parent {
  ...
  JreStrongAssign(&((OrgJsoupNodesNode *) nil_chk(clone))->parentNode_, parent);
  clone->siblingIndex_ = parent == nil ? 0 : siblingIndex_;
  JreStrongAssign(&clone->attributes_, attributes_ != nil ? [attributes_ java_clone] : nil);
  JreStrongAssign(&clone->baseUri_, baseUri_);
  JreStrongAssignAndConsume(&clone->childNodes_, new_JavaUtilArrayList_initWithInt_([((id<JavaUtilList>) nil_chk(childNodes_)) size]));
...
+ (void)initialize {
  if (self == [OrgJsoupNodesNode class]) {
    JreStrongAssign(&OrgJsoupNodesNode_EMPTY_NODES, JavaUtilCollections_emptyList());
...
void OrgJsoupNodesNode_initWithNSString_withOrgJsoupNodesAttributes_(OrgJsoupNodesNode *self, NSString *baseUri, OrgJsoupNodesAttributes *attributes) {
  ...
  JreStrongAssign(&self->childNodes_, OrgJsoupNodesNode_EMPTY_NODES);
  JreStrongAssign(&self->baseUri_, [((NSString *) nil_chk(baseUri)) java_trim]);
...
void OrgJsoupNodesNode_initWithNSString_(OrgJsoupNodesNode *self, NSString *baseUri) {
  OrgJsoupNodesNode_initWithNSString_withOrgJsoupNodesAttributes_(self, baseUri, create_OrgJsoupNodesAttributes_init());
}
...
void OrgJsoupNodesNode_addSiblingHtmlWithInt_withNSString_(OrgJsoupNodesNode *self, jint index, NSString *html) {
  ...
  [((OrgJsoupNodesNode *) nil_chk(self->parentNode_)) addChildrenWithInt:index withOrgJsoupNodesNodeArray:[((id<JavaUtilList>) nil_chk(nodes)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[nodes size] type:OrgJsoupNodesNode_class_()]]];
}
...
- (void)headWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)node
                          withInt:(jint)depth {
  JreStrongAssign(&((OrgJsoupNodesNode *) nil_chk(node))->baseUri_, val$baseUri_);
}
...
void OrgJsoupNodesNode_1_initWithNSString_(OrgJsoupNodesNode_1 *self, NSString *capture$0) {
  JreStrongAssign(&self->val$baseUri_, capture$0);
  NSObject_init(self);
}
...
void OrgJsoupNodesNode_OuterHtmlVisitor_initWithJavaLangStringBuilder_withOrgJsoupNodesDocument_OutputSettings_(OrgJsoupNodesNode_OuterHtmlVisitor *self, JavaLangStringBuilder *accum, OrgJsoupNodesDocument_OutputSettings *outArg) {
  NSObject_init(self);
  JreStrongAssign(&self->accum_, accum);
