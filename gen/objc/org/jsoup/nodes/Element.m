...
- (OrgJsoupNodesElement *)tagNameWithNSString:(NSString *)tagName {
  ...
  JreStrongAssign(&tag_, OrgJsoupParserTag_valueOfWithNSString_(tagName));
  return self;
}
...
- (OrgJsoupNodesElement *)attrWithNSString:(NSString *)attributeKey
  ...
  [super attrWithNSString:attributeKey withNSString:attributeValue];
  return self;
}
...
- (OrgJsoupSelectElements *)parents {
  OrgJsoupSelectElements *parents = create_OrgJsoupSelectElements_init();
...
- (OrgJsoupSelectElements *)children {
  id<JavaUtilList> elements = create_JavaUtilArrayList_initWithInt_([((id<JavaUtilList>) nil_chk(childNodes_)) size]);
  ...
  return create_OrgJsoupSelectElements_initWithJavaUtilList_(elements);
}

- (id<JavaUtilList>)textNodes {
  id<JavaUtilList> textNodes = create_JavaUtilArrayList_init();
  for (OrgJsoupNodesNode * __strong node in nil_chk(childNodes_)) {
...
- (id<JavaUtilList>)dataNodes {
  id<JavaUtilList> dataNodes = create_JavaUtilArrayList_init();
  for (OrgJsoupNodesNode * __strong node in nil_chk(childNodes_)) {
...
- (OrgJsoupNodesElement *)prependChildWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)child {
  OrgJsoupHelperValidate_notNullWithId_(child);
  [self addChildrenWithInt:0 withOrgJsoupNodesNodeArray:[IOSObjectArray arrayWithObjects:(id[]){ child } count:1 type:OrgJsoupNodesNode_class_()]];
  return self;
}
...
- (OrgJsoupNodesElement *)insertChildrenWithInt:(jint)index
  ...
  JavaUtilArrayList *nodes = create_JavaUtilArrayList_initWithJavaUtilCollection_(children);
  IOSObjectArray *nodeArray = [nodes toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[nodes size] type:OrgJsoupNodesNode_class_()]];
...
- (OrgJsoupNodesElement *)appendElementWithNSString:(NSString *)tagName {
  OrgJsoupNodesElement *child = create_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupParserTag_valueOfWithNSString_(tagName), [self baseUri]);
  [self appendChildWithOrgJsoupNodesNode:child];
  return child;
}

- (OrgJsoupNodesElement *)prependElementWithNSString:(NSString *)tagName {
  OrgJsoupNodesElement *child = create_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupParserTag_valueOfWithNSString_(tagName), [self baseUri]);
  [self prependChildWithOrgJsoupNodesNode:child];
  return child;
}

- (OrgJsoupNodesElement *)appendTextWithNSString:(NSString *)text {
  OrgJsoupNodesTextNode *node = create_OrgJsoupNodesTextNode_initWithNSString_withNSString_(text, [self baseUri]);
  [self appendChildWithOrgJsoupNodesNode:node];
  return self;
}

- (OrgJsoupNodesElement *)prependTextWithNSString:(NSString *)text {
  OrgJsoupNodesTextNode *node = create_OrgJsoupNodesTextNode_initWithNSString_withNSString_(text, [self baseUri]);
  [self prependChildWithOrgJsoupNodesNode:node];
  return self;
}
...
- (OrgJsoupNodesElement *)appendWithNSString:(NSString *)html {
  ...
  [self addChildrenWithOrgJsoupNodesNodeArray:[((id<JavaUtilList>) nil_chk(nodes)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[nodes size] type:OrgJsoupNodesNode_class_()]]];
  return self;
}
...
- (OrgJsoupNodesElement *)prependWithNSString:(NSString *)html {
  OrgJsoupHelperValidate_notNullWithId_(html);
  id<JavaUtilList> nodes = OrgJsoupParserParser_parseFragmentWithNSString_withOrgJsoupNodesElement_withNSString_(html, self, [self baseUri]);
  [self addChildrenWithInt:0 withOrgJsoupNodesNodeArray:[((id<JavaUtilList>) nil_chk(nodes)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[nodes size] type:OrgJsoupNodesNode_class_()]]];
  return self;
}
...
- (NSString *)cssSelector {
  ...
  JavaLangStringBuilder *selector = create_JavaLangStringBuilder_initWithNSString_([self tagName]);
  NSString *classes = OrgJsoupHelperStringUtil_joinWithJavaUtilCollection_withNSString_([self classNames], @".");
  if ([((NSString *) nil_chk(classes)) java_length] > 0) [((JavaLangStringBuilder *) nil_chk([selector appendWithChar:'.'])) appendWithNSString:classes];
  ...
  [selector insertWithInt:0 withNSString:@" > "];
  if ([((OrgJsoupSelectElements *) nil_chk([((OrgJsoupNodesElement *) nil_chk(OrgJsoupNodesElement_parent(self))) selectWithNSString:[selector description]])) size] > 1) [selector appendWithNSString:NSString_java_formatWithNSString_withNSObjectArray_(@":nth-child(%d)", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_([((JavaLangInteger *) nil_chk([self elementSiblingIndex])) intValue] + 1) } count:1 type:NSObject_class_()])];
...
- (OrgJsoupSelectElements *)siblingElements {
  if (parentNode_ == nil) return create_OrgJsoupSelectElements_initWithInt_(0);
  id<JavaUtilList> elements = [((OrgJsoupNodesElement *) nil_chk(OrgJsoupNodesElement_parent(self))) children];
  OrgJsoupSelectElements *siblings = create_OrgJsoupSelectElements_initWithInt_([((id<JavaUtilList>) nil_chk(elements)) size] - 1);
...
- (OrgJsoupSelectElements *)getElementsByTagWithNSString:(NSString *)tagName {
  ...
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_Tag_initWithNSString_(tagName), self);
}

- (OrgJsoupNodesElement *)getElementByIdWithNSString:(NSString *)id_ {
  OrgJsoupHelperValidate_notEmptyWithNSString_(id_);
  OrgJsoupSelectElements *elements = OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_Id_initWithNSString_(id_), self);
...
- (OrgJsoupSelectElements *)getElementsByClassWithNSString:(NSString *)className_ {
  ...
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_Class_initWithNSString_(className_), self);
}
...
- (OrgJsoupSelectElements *)getElementsByAttributeWithNSString:(NSString *)key {
  ...
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_Attribute_initWithNSString_(key), self);
}
...
- (OrgJsoupSelectElements *)getElementsByAttributeStartingWithNSString:(NSString *)keyPrefix {
  ...
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeStarting_initWithNSString_(keyPrefix), self);
}

- (OrgJsoupSelectElements *)getElementsByAttributeValueWithNSString:(NSString *)key
                                                       withNSString:(NSString *)value {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValue_initWithNSString_withNSString_(key, value), self);
}

- (OrgJsoupSelectElements *)getElementsByAttributeValueNotWithNSString:(NSString *)key
                                                          withNSString:(NSString *)value {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValueNot_initWithNSString_withNSString_(key, value), self);
}

- (OrgJsoupSelectElements *)getElementsByAttributeValueStartingWithNSString:(NSString *)key
                                                               withNSString:(NSString *)valuePrefix {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValueStarting_initWithNSString_withNSString_(key, valuePrefix), self);
}

- (OrgJsoupSelectElements *)getElementsByAttributeValueEndingWithNSString:(NSString *)key
                                                             withNSString:(NSString *)valueSuffix {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValueEnding_initWithNSString_withNSString_(key, valueSuffix), self);
}

- (OrgJsoupSelectElements *)getElementsByAttributeValueContainingWithNSString:(NSString *)key
                                                                 withNSString:(NSString *)match {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValueContaining_initWithNSString_withNSString_(key, match), self);
}
...
- (OrgJsoupSelectElements *)getElementsByAttributeValueMatchingWithNSString:(NSString *)key
  ...
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AttributeWithValueMatching_initWithNSString_withJavaUtilRegexPattern_(key, pattern), self);
}
...
- (OrgJsoupSelectElements *)getElementsByAttributeValueMatchingWithNSString:(NSString *)key
  ...
  @catch (JavaUtilRegexPatternSyntaxException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"Pattern syntax error: ", regex), e);
  }
...
- (OrgJsoupSelectElements *)getElementsByIndexLessThanWithInt:(jint)index {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_IndexLessThan_initWithInt_(index), self);
}

- (OrgJsoupSelectElements *)getElementsByIndexGreaterThanWithInt:(jint)index {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_IndexGreaterThan_initWithInt_(index), self);
}

- (OrgJsoupSelectElements *)getElementsByIndexEqualsWithInt:(jint)index {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_IndexEquals_initWithInt_(index), self);
}

- (OrgJsoupSelectElements *)getElementsContainingTextWithNSString:(NSString *)searchText {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_ContainsText_initWithNSString_(searchText), self);
}

- (OrgJsoupSelectElements *)getElementsContainingOwnTextWithNSString:(NSString *)searchText {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_ContainsOwnText_initWithNSString_(searchText), self);
}

- (OrgJsoupSelectElements *)getElementsMatchingTextWithJavaUtilRegexPattern:(JavaUtilRegexPattern *)pattern {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_Matches_initWithJavaUtilRegexPattern_(pattern), self);
}
...
- (OrgJsoupSelectElements *)getElementsMatchingOwnTextWithJavaUtilRegexPattern:(JavaUtilRegexPattern *)pattern {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_MatchesOwn_initWithJavaUtilRegexPattern_(pattern), self);
}
...
- (OrgJsoupSelectElements *)getAllElements {
  return OrgJsoupSelectCollector_collectWithOrgJsoupSelectEvaluator_withOrgJsoupNodesElement_(create_OrgJsoupSelectEvaluator_AllElements_init(), self);
}

- (NSString *)text {
  JavaLangStringBuilder *accum = create_JavaLangStringBuilder_init();
  [create_OrgJsoupSelectNodeTraversor_initWithOrgJsoupSelectNodeVisitor_(create_OrgJsoupNodesElement_1_initWithJavaLangStringBuilder_(accum)) traverseWithOrgJsoupNodesNode:self];
...
- (OrgJsoupNodesElement *)textWithNSString:(NSString *)text {
  ...
  [self empty];
  OrgJsoupNodesTextNode *textNode = create_OrgJsoupNodesTextNode_initWithNSString_withNSString_(text, baseUri_);
  [self appendChildWithOrgJsoupNodesNode:textNode];
  return self;
}
...
- (NSString *)data {
  ...
  for (OrgJsoupNodesNode * __strong childNode in nil_chk(childNodes_)) {
    if ([childNode isKindOfClass:[OrgJsoupNodesDataNode class]]) {
      ...
      [sb appendWithNSString:[((OrgJsoupNodesDataNode *) nil_chk(data)) getWholeData]];
    }
      ...
      [sb appendWithNSString:elementData];
    }
  }
...
- (id<JavaUtilSet>)classNames {
  ...
  id<JavaUtilSet> classNames = create_JavaUtilLinkedHashSet_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_(names));
...
- (OrgJsoupNodesElement *)addClassWithNSString:(NSString *)className_ {
  ...
  [self classNamesWithJavaUtilSet:classes];
  return self;
}
...
- (OrgJsoupNodesElement *)valWithNSString:(NSString *)value {
  if ([((NSString *) nil_chk([self tagName])) isEqual:@"textarea"]) [self textWithNSString:value];
  else [self attrWithNSString:@"value" withNSString:value];
  return self;
}
...
- (void)outerHtmlHeadWithJavaLangStringBuilder:(JavaLangStringBuilder *)accum
  ...
  [((JavaLangStringBuilder *) nil_chk([accum appendWithNSString:@"<"])) appendWithNSString:[self tagName]];
  ...
  if ([((id<JavaUtilList>) nil_chk(childNodes_)) isEmpty] && [((OrgJsoupParserTag *) nil_chk(tag_)) isSelfClosing]) {
    if ([((OrgJsoupNodesDocument_OutputSettings *) nil_chk(outArg)) syntax] == JreLoadEnum(OrgJsoupNodesDocument_OutputSettings_Syntax, html) && [((OrgJsoupParserTag *) nil_chk(tag_)) isEmpty]) [accum appendWithChar:'>'];
    else [accum appendWithNSString:@" />"];
  }
  else [accum appendWithNSString:@">"];
}
...
- (void)outerHtmlTailWithJavaLangStringBuilder:(JavaLangStringBuilder *)accum
  ...
  if (!([((id<JavaUtilList>) nil_chk(childNodes_)) isEmpty] && [((OrgJsoupParserTag *) nil_chk(tag_)) isSelfClosing])) {
    ...
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:@"</"])) appendWithNSString:[self tagName]])) appendWithNSString:@">"];
  }
}
...
+ (void)initialize {
  if (self == [OrgJsoupNodesElement class]) {
    JreStrongAssign(&OrgJsoupNodesElement_classSplit, JavaUtilRegexPattern_compileWithNSString_(@"\\s+"));
...
void OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupNodesElement *self, OrgJsoupParserTag *tag, NSString *baseUri) {
  OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_withOrgJsoupNodesAttributes_(self, tag, baseUri, create_OrgJsoupNodesAttributes_init());
}
...
void OrgJsoupNodesElement_appendNormalisedTextWithJavaLangStringBuilder_withOrgJsoupNodesTextNode_(JavaLangStringBuilder *accum, OrgJsoupNodesTextNode *textNode) {
  ...
  if (OrgJsoupNodesElement_preserveWhitespaceWithOrgJsoupNodesNode_(textNode->parentNode_)) [((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:text];
...
void OrgJsoupNodesElement_appendWhitespaceIfBrWithOrgJsoupNodesElement_withJavaLangStringBuilder_(OrgJsoupNodesElement *element, JavaLangStringBuilder *accum) {
  OrgJsoupNodesElement_initialize();
  if ([((NSString *) nil_chk([((OrgJsoupParserTag *) nil_chk(((OrgJsoupNodesElement *) nil_chk(element))->tag_)) getName])) isEqual:@"br"] && !OrgJsoupNodesTextNode_lastCharIsWhitespaceWithJavaLangStringBuilder_(accum)) [((JavaLangStringBuilder *) nil_chk(accum)) appendWithNSString:@" "];
}
...
- (void)headWithOrgJsoupNodesNode:(OrgJsoupNodesNode *)node
  ...
  if ([node isKindOfClass:[OrgJsoupNodesTextNode class]]) {
    ...
    OrgJsoupNodesElement *element = (OrgJsoupNodesElement *) cast_chk(node, [OrgJsoupNodesElement class]);
    if ([((JavaLangStringBuilder *) nil_chk(val$accum_)) java_length] > 0 && ([((OrgJsoupNodesElement *) nil_chk(element)) isBlock] || [((NSString *) nil_chk([((OrgJsoupParserTag *) nil_chk(element->tag_)) getName])) isEqual:@"br"]) && !OrgJsoupNodesTextNode_lastCharIsWhitespaceWithJavaLangStringBuilder_(val$accum_)) [val$accum_ appendWithNSString:@" "];
  }
}
...
void OrgJsoupNodesElement_1_initWithJavaLangStringBuilder_(OrgJsoupNodesElement_1 *self, JavaLangStringBuilder *capture$0) {
  JreStrongAssign(&self->val$accum_, capture$0);
  NSObject_init(self);
}
