...
/*!
 @brief Ensures a meta charset (html) or xml declaration (xml) with the current
  encoding used.This only applies with 
 <code>updateMetaCharset</code> set to 
...
- (void)titleWithNSString:(NSString *)title {
  ...
  OrgJsoupNodesElement *titleEl = [((OrgJsoupSelectElements *) nil_chk([self getElementsByTagWithNSString:@"title"])) first];
  if (titleEl == nil) {
    [((OrgJsoupNodesElement *) nil_chk([((OrgJsoupNodesElement *) nil_chk([self head])) appendElementWithNSString:@"title"])) textWithNSString:title];
  }
  else {
    [titleEl textWithNSString:title];
  }
}

- (OrgJsoupNodesElement *)createElementWithNSString:(NSString *)tagName {
  return create_OrgJsoupNodesElement_initWithOrgJsoupParserTag_withNSString_(OrgJsoupParserTag_valueOfWithNSString_(tagName), [self baseUri]);
}
...
- (OrgJsoupNodesDocument *)normalise {
  ...
  if ([self head] == nil) [((OrgJsoupNodesElement *) nil_chk(htmlEl)) prependElementWithNSString:@"head"];
  if ([self body] == nil) [((OrgJsoupNodesElement *) nil_chk(htmlEl)) appendElementWithNSString:@"body"];
...
- (OrgJsoupNodesElement *)textWithNSString:(NSString *)text {
  [((OrgJsoupNodesElement *) nil_chk([self body])) textWithNSString:text];
  return self;
}
...
- (void)charsetWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  ...
  [((OrgJsoupNodesDocument_OutputSettings *) nil_chk(outputSettings_)) charsetWithJavaNioCharsetCharset:charset];
  OrgJsoupNodesDocument_ensureMetaCharsetElement(self);
}
...
- (OrgJsoupNodesDocument *)java_clone {
  ...
  JreStrongAssign(&((OrgJsoupNodesDocument *) nil_chk(clone))->outputSettings_, [((OrgJsoupNodesDocument_OutputSettings *) nil_chk(self->outputSettings_)) java_clone]);
  return clone;
}
...
- (OrgJsoupNodesDocument *)outputSettingsWithOrgJsoupNodesDocument_OutputSettings:(OrgJsoupNodesDocument_OutputSettings *)outputSettings {
  ...
  JreStrongAssign(&self->outputSettings_, outputSettings);
  return self;
}
...
- (OrgJsoupNodesDocument *)quirksModeWithOrgJsoupNodesDocument_QuirksMode:(OrgJsoupNodesDocument_QuirksMode *)quirksMode {
  JreStrongAssign(&self->quirksMode_, quirksMode);
  return self;
}

- (void)dealloc {
  RELEASE_(outputSettings_);
  RELEASE_(quirksMode_);
  RELEASE_(location_);
  [super dealloc];
}
...
void OrgJsoupNodesDocument_initWithNSString_(OrgJsoupNodesDocument *self, NSString *baseUri) {
  ...
  JreStrongAssignAndConsume(&self->outputSettings_, new_OrgJsoupNodesDocument_OutputSettings_init());
  JreStrongAssign(&self->quirksMode_, JreLoadEnum(OrgJsoupNodesDocument_QuirksMode, noQuirks));
  self->updateMetaCharset_ = false;
  JreStrongAssign(&self->location_, baseUri);
}
...
OrgJsoupNodesDocument *OrgJsoupNodesDocument_createShellWithNSString_(NSString *baseUri) {
  ...
  OrgJsoupNodesDocument *doc = create_OrgJsoupNodesDocument_initWithNSString_(baseUri);
  OrgJsoupNodesElement *html = [doc appendElementWithNSString:@"html"];
  [((OrgJsoupNodesElement *) nil_chk(html)) appendElementWithNSString:@"head"];
  [html appendElementWithNSString:@"body"];
  return doc;
}
...
void OrgJsoupNodesDocument_normaliseTextNodesWithOrgJsoupNodesElement_(OrgJsoupNodesDocument *self, OrgJsoupNodesElement *element) {
  id<JavaUtilList> toMove = create_JavaUtilArrayList_init();
  ...
  for (jint i = [toMove size] - 1; i >= 0; i--) {
    ...
    [((OrgJsoupNodesElement *) nil_chk([self body])) prependChildWithOrgJsoupNodesNode:create_OrgJsoupNodesTextNode_initWithNSString_withNSString_(@" ", @"")];
    [((OrgJsoupNodesElement *) nil_chk([self body])) prependChildWithOrgJsoupNodesNode:node];
  }
}
...
void OrgJsoupNodesDocument_normaliseStructureWithNSString_withOrgJsoupNodesElement_(OrgJsoupNodesDocument *self, NSString *tag, OrgJsoupNodesElement *htmlEl) {
  ...
  if ([elements size] > 1) {
    ...
    for (OrgJsoupNodesNode * __strong dupe in toMove) [((OrgJsoupNodesElement *) nil_chk(master)) appendChildWithOrgJsoupNodesNode:dupe];
  }
  if (![((OrgJsoupNodesElement *) nil_chk([((OrgJsoupNodesElement *) nil_chk(master)) parent])) isEqual:htmlEl]) {
    [((OrgJsoupNodesElement *) nil_chk(htmlEl)) appendChildWithOrgJsoupNodesNode:master];
  }
}
...
void OrgJsoupNodesDocument_ensureMetaCharsetElement(OrgJsoupNodesDocument *self) {
  if (self->updateMetaCharset_) {
    ...
    if (syntax == JreLoadEnum(OrgJsoupNodesDocument_OutputSettings_Syntax, html)) {
      ...
      if (metaCharset != nil) {
        [metaCharset attrWithNSString:@"charset" withNSString:[((JavaNioCharsetCharset *) nil_chk([self charset])) displayName]];
      }
      else {
        OrgJsoupNodesElement *head = [self head];
        if (head != nil) {
          [((OrgJsoupNodesElement *) nil_chk([head appendElementWithNSString:@"meta"])) attrWithNSString:@"charset" withNSString:[((JavaNioCharsetCharset *) nil_chk([self charset])) displayName]];
        }
      }
      [((OrgJsoupSelectElements *) nil_chk([self selectWithNSString:@"meta[name=charset]"])) remove];
    }
      ...
      if ([node isKindOfClass:[OrgJsoupNodesXmlDeclaration class]]) {
        ...
        if ([((NSString *) nil_chk([((OrgJsoupNodesXmlDeclaration *) nil_chk(decl)) attrWithNSString:OrgJsoupNodesXmlDeclaration_DECL_KEY])) isEqual:@"xml"]) {
          [decl attrWithNSString:@"encoding" withNSString:[((JavaNioCharsetCharset *) nil_chk([self charset])) displayName]];
          NSString *version_ = [decl attrWithNSString:@"version"];
          if (version_ != nil) {
            [decl attrWithNSString:@"version" withNSString:@"1.0"];
          }
        }
        else {
          decl = create_OrgJsoupNodesXmlDeclaration_initWithNSString_withNSString_withBoolean_(@"xml", self->baseUri_, false);
          [decl attrWithNSString:@"version" withNSString:@"1.0"];
          [decl attrWithNSString:@"encoding" withNSString:[((JavaNioCharsetCharset *) nil_chk([self charset])) displayName]];
          [self prependChildWithOrgJsoupNodesNode:decl];
        }
      }
      else {
        OrgJsoupNodesXmlDeclaration *decl = create_OrgJsoupNodesXmlDeclaration_initWithNSString_withNSString_withBoolean_(@"xml", self->baseUri_, false);
        [decl attrWithNSString:@"version" withNSString:@"1.0"];
        [decl attrWithNSString:@"encoding" withNSString:[((JavaNioCharsetCharset *) nil_chk([self charset])) displayName]];
        [self prependChildWithOrgJsoupNodesNode:decl];
      }
...
- (OrgJsoupNodesDocument_OutputSettings *)escapeModeWithOrgJsoupNodesEntities_EscapeMode:(OrgJsoupNodesEntities_EscapeMode *)escapeMode {
  JreStrongAssign(&self->escapeMode_, escapeMode);
  return self;
}
...
- (OrgJsoupNodesDocument_OutputSettings *)charsetWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  ...
  JreStrongAssign(&charsetEncoder_, [((JavaNioCharsetCharset *) nil_chk(charset)) newEncoder]);
  return self;
}

- (OrgJsoupNodesDocument_OutputSettings *)charsetWithNSString:(NSString *)charset {
  [self charsetWithJavaNioCharsetCharset:JavaNioCharsetCharset_forNameWithNSString_(charset)];
  return self;
}
...
- (OrgJsoupNodesDocument_OutputSettings *)syntaxWithOrgJsoupNodesDocument_OutputSettings_Syntax:(OrgJsoupNodesDocument_OutputSettings_Syntax *)syntax {
  JreStrongAssign(&self->syntax_, syntax);
  return self;
}
...
- (OrgJsoupNodesDocument_OutputSettings *)java_clone {
  ...
  [((OrgJsoupNodesDocument_OutputSettings *) nil_chk(clone)) charsetWithNSString:[((JavaNioCharsetCharset *) nil_chk(charset_)) name]];
  JreStrongAssign(&clone->escapeMode_, OrgJsoupNodesEntities_EscapeMode_valueOfWithNSString_([((OrgJsoupNodesEntities_EscapeMode *) nil_chk(escapeMode_)) name]));
  return clone;
}

- (void)dealloc {
  RELEASE_(escapeMode_);
  RELEASE_(charset_);
  RELEASE_(charsetEncoder_);
  RELEASE_(syntax_);
  [super dealloc];
}
...
void OrgJsoupNodesDocument_OutputSettings_init(OrgJsoupNodesDocument_OutputSettings *self) {
  NSObject_init(self);
  JreStrongAssign(&self->escapeMode_, JreLoadEnum(OrgJsoupNodesEntities_EscapeMode, base));
  JreStrongAssign(&self->charset_, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-8"));
  JreStrongAssign(&self->charsetEncoder_, [((JavaNioCharsetCharset *) nil_chk(self->charset_)) newEncoder]);
  self->prettyPrint_ = true;
  self->outline_ = false;
  self->indentAmount_ = 1;
  JreStrongAssign(&self->syntax_, JreLoadEnum(OrgJsoupNodesDocument_OutputSettings_Syntax, html));
}
