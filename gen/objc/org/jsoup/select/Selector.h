...
//  source: /Users/marcussmith/temp/jsoup/src/main/java/org/jsoup/select/Selector.java
//
...
/*!
 @brief CSS-like element selector, that finds elements matching a query.
 <h2>Selector syntax</h2>
  ...
  <p>
  The universal selector (*) is implicit when no element selector is supplied (i.e. <code>*.header</code> and <code>.header</code>
  is equivalent). 
 </p>
  <table summary="">
  <tr><th align="left">Pattern</th><th align="left">Matches</th><th align="left">Example</th></tr>
  <tr><td><code>*</code></td><td>any element</td><td><code>
 *</code></td></tr> <tr><td><code>tag</code></td><td>elements with the given tag name</td><td><code>div</code></td></tr>
  ...
  <tr><td><code>:not(<em>selector</em>)</code></td><td>elements that do not match the <em>selector</em>. See also <code>Elements.not(String)</code></td><td><code>div:not(.logo)</code> finds all divs that do not have the "logo" class.<p><code>div:not(:has(div))</code> finds divs that do not contain divs.</p></td></tr>
...
/*!
 @brief Find elements matching selector.
