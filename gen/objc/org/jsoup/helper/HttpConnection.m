...
//  source: /Users/marcussmith/temp/jsoup/src/main/java/org/jsoup/helper/HttpConnection.java
//
...
/*!
 @brief Instantiate Hostname Verifier that does nothing.
...
/*!
 @brief Initialise Trust manager that does not validate certificate chains and
...
- (id<OrgJsoupConnection>)urlWithJavaNetURL:(JavaNetURL *)url {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) urlWithJavaNetURL:url];
  return self;
}
...
- (id<OrgJsoupConnection>)urlWithNSString:(NSString *)url {
  ...
  @try {
    [((id<OrgJsoupConnection_Request>) nil_chk(req_)) urlWithJavaNetURL:create_JavaNetURL_initWithNSString_(OrgJsoupHelperHttpConnection_encodeUrlWithNSString_(url))];
  }
  @catch (JavaNetMalformedURLException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$", @"Malformed URL: ", url), e);
  }
  return self;
}
...
- (id<OrgJsoupConnection>)userAgentWithNSString:(NSString *)userAgent {
  ...
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) headerWithNSString:@"User-Agent" withNSString:userAgent];
  return self;
}

- (id<OrgJsoupConnection>)timeoutWithInt:(jint)millis {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) timeoutWithInt:millis];
  return self;
}

- (id<OrgJsoupConnection>)maxBodySizeWithInt:(jint)bytes {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) maxBodySizeWithInt:bytes];
  return self;
}

- (id<OrgJsoupConnection>)followRedirectsWithBoolean:(jboolean)followRedirects {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) followRedirectsWithBoolean:followRedirects];
  return self;
}
...
- (id<OrgJsoupConnection>)referrerWithNSString:(NSString *)referrer {
  ...
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) headerWithNSString:@"Referer" withNSString:referrer];
  return self;
}

- (id<OrgJsoupConnection>)methodWithOrgJsoupConnection_Method:(OrgJsoupConnection_Method *)method {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) methodWithOrgJsoupConnection_Method:method];
  return self;
}

- (id<OrgJsoupConnection>)ignoreHttpErrorsWithBoolean:(jboolean)ignoreHttpErrors {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) ignoreHttpErrorsWithBoolean:ignoreHttpErrors];
  return self;
}

- (id<OrgJsoupConnection>)ignoreContentTypeWithBoolean:(jboolean)ignoreContentType {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) ignoreContentTypeWithBoolean:ignoreContentType];
  return self;
}
...
- (id<OrgJsoupConnection>)dataWithNSString:(NSString *)key
  ...
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) dataWithOrgJsoupConnection_KeyVal:OrgJsoupHelperHttpConnection_KeyVal_createWithNSString_withNSString_(key, value)];
  return self;
}
...
- (id<OrgJsoupConnection>)dataWithNSString:(NSString *)key
  ...
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) dataWithOrgJsoupConnection_KeyVal:OrgJsoupHelperHttpConnection_KeyVal_createWithNSString_withNSString_withJavaIoInputStream_(key, filename, inputStream)];
  return self;
}
...
- (id<OrgJsoupConnection>)dataWithJavaUtilMap:(id<JavaUtilMap>)data {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(data)) entrySet])) {
    [((id<OrgJsoupConnection_Request>) nil_chk(req_)) dataWithOrgJsoupConnection_KeyVal:OrgJsoupHelperHttpConnection_KeyVal_createWithNSString_withNSString_([((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey], [entry_ getValue])];
  }
  return self;
}
...
- (id<OrgJsoupConnection>)dataWithJavaUtilCollection:(id<JavaUtilCollection>)data {
  ...
  for (id<OrgJsoupConnection_KeyVal> __strong entry_ in nil_chk(data)) {
    [((id<OrgJsoupConnection_Request>) nil_chk(req_)) dataWithOrgJsoupConnection_KeyVal:entry_];
  }
  return self;
}
...
- (id<OrgJsoupConnection>)headerWithNSString:(NSString *)name
                                withNSString:(NSString *)value {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) headerWithNSString:name withNSString:value];
  return self;
}

- (id<OrgJsoupConnection>)cookieWithNSString:(NSString *)name
                                withNSString:(NSString *)value {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) cookieWithNSString:name withNSString:value];
  return self;
}
...
- (id<OrgJsoupConnection>)cookiesWithJavaUtilMap:(id<JavaUtilMap>)cookies {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(cookies)) entrySet])) {
    [((id<OrgJsoupConnection_Request>) nil_chk(req_)) cookieWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey] withNSString:[entry_ getValue]];
  }
  return self;
}

- (id<OrgJsoupConnection>)parserWithOrgJsoupParserParser:(OrgJsoupParserParser *)parser {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) parserWithOrgJsoupParserParser:parser];
  return self;
}

- (OrgJsoupNodesDocument *)get {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) methodWithOrgJsoupConnection_Method:JreLoadEnum(OrgJsoupConnection_Method, GET)];
  [self execute];
  return [((id<OrgJsoupConnection_Response>) nil_chk(res_)) parse];
}

- (OrgJsoupNodesDocument *)post {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) methodWithOrgJsoupConnection_Method:JreLoadEnum(OrgJsoupConnection_Method, POST)];
  [self execute];
  return [((id<OrgJsoupConnection_Response>) nil_chk(res_)) parse];
}

- (id<OrgJsoupConnection_Response>)execute {
  JreStrongAssign(&res_, OrgJsoupHelperHttpConnection_Response_executeWithOrgJsoupConnection_Request_(req_));
  return res_;
}
...
- (id<OrgJsoupConnection>)responseWithOrgJsoupConnection_Response:(id<OrgJsoupConnection_Response>)response {
  JreStrongAssign(&res_, response);
  return self;
}

- (id<OrgJsoupConnection>)postDataCharsetWithNSString:(NSString *)charset {
  [((id<OrgJsoupConnection_Request>) nil_chk(req_)) postDataCharsetWithNSString:charset];
  return self;
}
...
id<OrgJsoupConnection> OrgJsoupHelperHttpConnection_connectWithNSString_(NSString *url) {
  ...
  id<OrgJsoupConnection> con = create_OrgJsoupHelperHttpConnection_init();
  [con urlWithNSString:url];
  return con;
}
...
void OrgJsoupHelperHttpConnection_init(OrgJsoupHelperHttpConnection *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->req_, new_OrgJsoupHelperHttpConnection_Request_init());
  JreStrongAssignAndConsume(&self->res_, new_OrgJsoupHelperHttpConnection_Response_init());
}
...
- (id<OrgJsoupConnection_Base>)headerWithNSString:(NSString *)name
  ...
  [self removeHeaderWithNSString:name];
  [((id<JavaUtilMap>) nil_chk(headers_)) putWithId:name withId:value];
  return self;
}
...
- (id<OrgJsoupConnection_Base>)removeHeaderWithNSString:(NSString *)name {
  ...
  if (entry_ != nil) [((id<JavaUtilMap>) nil_chk(headers_)) removeWithId:[entry_ getKey]];
  return self;
}
...
- (id<OrgJsoupConnection_Base>)cookieWithNSString:(NSString *)name
  ...
  [((id<JavaUtilMap>) nil_chk(cookies_)) putWithId:name withId:value];
  return self;
}
...
- (id<OrgJsoupConnection_Base>)removeCookieWithNSString:(NSString *)name {
  OrgJsoupHelperValidate_notEmptyWithNSString_withNSString_(name, @"Cookie name must not be empty");
  [((id<JavaUtilMap>) nil_chk(cookies_)) removeWithId:name];
  return self;
}
...
void OrgJsoupHelperHttpConnection_Base_init(OrgJsoupHelperHttpConnection_Base *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->headers_, new_JavaUtilLinkedHashMap_init());
  JreStrongAssignAndConsume(&self->cookies_, new_JavaUtilLinkedHashMap_init());
}
...
- (id<OrgJsoupConnection_Request>)postDataCharsetWithNSString:(NSString *)charset {
  ...
  if (!JavaNioCharsetCharset_isSupportedWithNSString_(charset)) @throw create_JavaNioCharsetIllegalCharsetNameException_initWithNSString_(charset);
  JreStrongAssign(&self->postDataCharset_, charset);
  return self;
}
...
void OrgJsoupHelperHttpConnection_Request_init(OrgJsoupHelperHttpConnection_Request *self) {
  ...
  JreStrongAssign(&self->postDataCharset_, OrgJsoupHelperDataUtil_defaultCharset);
  self->timeoutMilliseconds_ = 3000;
  self->maxBodySizeBytes_ = 1024 * 1024;
  self->followRedirects_ = true;
  JreStrongAssignAndConsume(&self->data_, new_JavaUtilArrayList_init());
  JreStrongAssign(&self->method_, JreLoadEnum(OrgJsoupConnection_Method, GET));
  [((id<JavaUtilMap>) nil_chk(self->headers_)) putWithId:@"Accept-Encoding" withId:@"gzip"];
  JreStrongAssign(&self->parser_, OrgJsoupParserParser_htmlParser());
}
...
- (OrgJsoupNodesDocument *)parse {
  ...
  [((JavaNioByteBuffer *) nil_chk(byteData_)) rewind];
  JreStrongAssign(&charset_, [((JavaNioCharsetCharset *) nil_chk([((OrgJsoupNodesDocument_OutputSettings *) nil_chk([((OrgJsoupNodesDocument *) nil_chk(doc)) outputSettings])) charset])) name]);
  return doc;
}
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(resHeaders)) entrySet])) {
    ...
    if ([name java_equalsIgnoreCase:@"Set-Cookie"]) {
      for (NSString * __strong value in nil_chk(values)) {
        ...
        OrgJsoupParserTokenQueue *cd = create_OrgJsoupParserTokenQueue_initWithNSString_(value);
        ...
        if ([((NSString *) nil_chk(cookieName)) java_length] > 0) [self cookieWithNSString:cookieName withNSString:cookieVal];
      }
    }
    else {
      if (![((id<JavaUtilList>) nil_chk(values)) isEmpty]) [self headerWithNSString:name withNSString:[values getWithInt:0]];
    }
  }
}
...
+ (void)initialize {
  if (self == [OrgJsoupHelperHttpConnection_Response class]) {
    JreStrongAssign(&OrgJsoupHelperHttpConnection_Response_xmlContentTypeRxp, JavaUtilRegexPattern_compileWithNSString_(@"(application|text)/\\w*\\+?xml.*"));
...
void OrgJsoupHelperHttpConnection_Response_initWithOrgJsoupHelperHttpConnection_Response_(OrgJsoupHelperHttpConnection_Response *self, OrgJsoupHelperHttpConnection_Response *previousResponse) {
  ...
  if (previousResponse != nil) {
    ...
    if (self->numRedirects_ >= OrgJsoupHelperHttpConnection_Response_MAX_REDIRECTS) @throw create_JavaIoIOException_initWithNSString_(NSString_java_formatWithNSString_withNSObjectArray_(@"Too many redirects occurred trying to load URL %s", [IOSObjectArray arrayWithObjects:(id[]){ [previousResponse url] } count:1 type:NSObject_class_()]));
  }
}
...
OrgJsoupHelperHttpConnection_Response *OrgJsoupHelperHttpConnection_Response_executeWithOrgJsoupConnection_Request_withOrgJsoupHelperHttpConnection_Response_(id<OrgJsoupConnection_Request> req, OrgJsoupHelperHttpConnection_Response *previousResponse) {
  ...
  if (![((NSString *) nil_chk(protocol)) isEqual:@"http"] && ![protocol isEqual:@"https"]) @throw create_JavaNetMalformedURLException_initWithNSString_(@"Only http & https protocols supported");
  ...
  @try {
    ...
    res = create_OrgJsoupHelperHttpConnection_Response_initWithOrgJsoupHelperHttpConnection_Response_(previousResponse);
    ...
    JreStrongAssign(&res->req_, req);
    if ([res hasHeaderWithNSString:OrgJsoupHelperHttpConnection_Response_LOCATION] && [req followRedirects]) {
      [req methodWithOrgJsoupConnection_Method:JreLoadEnum(OrgJsoupConnection_Method, GET)];
      ...
      [req urlWithJavaNetURL:OrgJsoupHelperStringUtil_resolveWithJavaNetURL_withNSString_([req url], OrgJsoupHelperHttpConnection_encodeUrlWithNSString_(location))];
      for (id<JavaUtilMap_Entry> __strong cookie in nil_chk([((id<JavaUtilMap>) nil_chk(res->cookies_)) entrySet])) {
        [req cookieWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(cookie)) getKey] withNSString:[cookie getValue]];
      }
    ...
    if ((status < 200 || status >= 400) && ![req ignoreHttpErrors]) @throw create_OrgJsoupHttpStatusException_initWithNSString_withInt_withNSString_(@"HTTP error fetching URL", status, [((JavaNetURL *) nil_chk([req url])) description]);
    NSString *contentType = [res contentType];
    if (contentType != nil && ![req ignoreContentType] && ![contentType java_hasPrefix:@"text/"] && ![((JavaUtilRegexMatcher *) nil_chk([((JavaUtilRegexPattern *) nil_chk(OrgJsoupHelperHttpConnection_Response_xmlContentTypeRxp)) matcherWithJavaLangCharSequence:contentType])) matches]) @throw create_OrgJsoupUnsupportedMimeTypeException_initWithNSString_withNSString_withNSString_(@"Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml", contentType, [((JavaNetURL *) nil_chk([req url])) description]);
    if (contentType != nil && [((JavaUtilRegexMatcher *) nil_chk([((JavaUtilRegexPattern *) nil_chk(OrgJsoupHelperHttpConnection_Response_xmlContentTypeRxp)) matcherWithJavaLangCharSequence:contentType])) matches]) {
      if ([req isKindOfClass:[OrgJsoupHelperHttpConnection_Request class]] && !((OrgJsoupHelperHttpConnection_Request *) cast_chk(req, [OrgJsoupHelperHttpConnection_Request class]))->parserDefined_) {
        [req parserWithOrgJsoupParserParser:OrgJsoupParserParser_xmlParser()];
      }
    }
    JreStrongAssign(&res->charset_, OrgJsoupHelperDataUtil_getCharsetFromContentTypeWithNSString_(res->contentType_));
    if ([conn getContentLength] != 0) {
      ...
      @try {
        ...
        bodyStream = [res hasHeaderWithValueWithNSString:OrgJsoupHelperHttpConnection_CONTENT_ENCODING withNSString:@"gzip"] ? create_JavaIoBufferedInputStream_initWithJavaIoInputStream_(create_JavaUtilZipGZIPInputStream_initWithJavaIoInputStream_(dataStream)) : create_JavaIoBufferedInputStream_initWithJavaIoInputStream_(dataStream);
        JreStrongAssign(&res->byteData_, OrgJsoupHelperDataUtil_readToByteBufferWithJavaIoInputStream_withInt_(bodyStream, [req maxBodySize]));
      }
      @finally {
      ...
      JreStrongAssign(&res->byteData_, OrgJsoupHelperDataUtil_emptyByteBuffer());
    }
  }
  @finally {
    [conn disconnect];
...
id<JavaxNetSslHostnameVerifier> OrgJsoupHelperHttpConnection_Response_getInsecureVerifier() {
  OrgJsoupHelperHttpConnection_Response_initialize();
  return create_OrgJsoupHelperHttpConnection_Response_1_init();
}
...
void OrgJsoupHelperHttpConnection_Response_initUnSecureTSL() {
  ...
  @synchronized(OrgJsoupHelperHttpConnection_Response_class_()) {
    if (OrgJsoupHelperHttpConnection_Response_sslSocketFactory == nil) {
      IOSObjectArray *trustAllCerts = [IOSObjectArray arrayWithObjects:(id[]){ create_OrgJsoupHelperHttpConnection_Response_2_init() } count:1 type:JavaxNetSslTrustManager_class_()];
      JavaxNetSslSSLContext *sslContext;
      @try {
        sslContext = JavaxNetSslSSLContext_getInstanceWithNSString_(@"SSL");
        [((JavaxNetSslSSLContext *) nil_chk(sslContext)) init__WithJavaxNetSslKeyManagerArray:nil withJavaxNetSslTrustManagerArray:trustAllCerts withJavaSecuritySecureRandom:create_JavaSecuritySecureRandom_init()];
        JreStrongAssign(&OrgJsoupHelperHttpConnection_Response_sslSocketFactory, [sslContext getSocketFactory]);
      }
      @catch (JavaSecurityNoSuchAlgorithmException *e) {
        @throw create_JavaIoIOException_initWithNSString_(@"Can't create unsecure trust manager");
      }
...
void OrgJsoupHelperHttpConnection_Response_setupFromConnectionWithJavaNetHttpURLConnection_withOrgJsoupConnection_Response_(OrgJsoupHelperHttpConnection_Response *self, JavaNetHttpURLConnection *conn, id<OrgJsoupConnection_Response> previousResponse) {
  JreStrongAssign(&self->method_, OrgJsoupConnection_Method_valueOfWithNSString_([((JavaNetHttpURLConnection *) nil_chk(conn)) getRequestMethod]));
  JreStrongAssign(&self->url_, [conn getURL]);
  self->statusCode_ = [conn getResponseCode];
  JreStrongAssign(&self->statusMessage_, [conn getResponseMessage]);
  JreStrongAssign(&self->contentType_, [conn getContentType]);
  ...
  if (previousResponse != nil) {
    for (id<JavaUtilMap_Entry> __strong prevCookie in nil_chk([((id<JavaUtilMap>) nil_chk([previousResponse cookies])) entrySet])) {
      if (![self hasCookieWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(prevCookie)) getKey]]) [self cookieWithNSString:[prevCookie getKey] withNSString:[prevCookie getValue]];
    }
  }
}
...
NSString *OrgJsoupHelperHttpConnection_Response_setOutputContentTypeWithOrgJsoupConnection_Request_(id<OrgJsoupConnection_Request> req) {
  ...
  if (needsMulti) {
    ...
    [req headerWithNSString:OrgJsoupHelperHttpConnection_CONTENT_TYPE withNSString:JreStrcat("$$$", OrgJsoupHelperHttpConnection_MULTIPART_FORM_DATA, @"; boundary=", bound)];
  }
  else {
    [req headerWithNSString:OrgJsoupHelperHttpConnection_CONTENT_TYPE withNSString:JreStrcat("$$$", OrgJsoupHelperHttpConnection_FORM_URL_ENCODED, @"; charset=", [req postDataCharset])];
  }
  return bound;
}
...
void OrgJsoupHelperHttpConnection_Response_writePostWithOrgJsoupConnection_Request_withJavaIoOutputStream_withNSString_(id<OrgJsoupConnection_Request> req, JavaIoOutputStream *outputStream, NSString *bound) {
  ...
  JavaIoBufferedWriter *w = create_JavaIoBufferedWriter_initWithJavaIoWriter_(create_JavaIoOutputStreamWriter_initWithJavaIoOutputStream_withNSString_(outputStream, OrgJsoupHelperDataUtil_defaultCharset));
  if (bound != nil) {
...
NSString *OrgJsoupHelperHttpConnection_Response_getRequestCookieStringWithOrgJsoupConnection_Request_(id<OrgJsoupConnection_Request> req) {
  ...
  for (id<JavaUtilMap_Entry> __strong cookie in nil_chk([((id<JavaUtilMap>) nil_chk([((id<OrgJsoupConnection_Request>) nil_chk(req)) cookies])) entrySet])) {
    ...
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(cookie)) getKey]])) appendWithChar:'='])) appendWithNSString:[cookie getValue]];
  }
...
void OrgJsoupHelperHttpConnection_Response_serialiseRequestUrlWithOrgJsoupConnection_Request_(id<OrgJsoupConnection_Request> req) {
  ...
  JavaLangStringBuilder *url = create_JavaLangStringBuilder_init();
  jboolean first = true;
  [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([url appendWithNSString:[((JavaNetURL *) nil_chk(in)) getProtocol]])) appendWithNSString:@"://"])) appendWithNSString:[in getAuthority]])) appendWithNSString:[in getPath]])) appendWithNSString:@"?"];
  if ([in getQuery] != nil) {
    [url appendWithNSString:[in getQuery]];
    first = false;
  }
  for (id<OrgJsoupConnection_KeyVal> __strong keyVal in nil_chk([req data])) {
    if (!first) [url appendWithChar:'&'];
    else first = false;
  ...
  [req urlWithJavaNetURL:create_JavaNetURL_initWithNSString_([url description])];
  [((id<JavaUtilCollection>) nil_chk([req data])) clear];
}
...
- (OrgJsoupHelperHttpConnection_KeyVal *)inputStreamWithJavaIoInputStream:(JavaIoInputStream *)inputStream {
  ...
  JreStrongAssign(&self->stream_, inputStream);
  return self;
}
...
OrgJsoupHelperHttpConnection_KeyVal *OrgJsoupHelperHttpConnection_KeyVal_createWithNSString_withNSString_(NSString *key, NSString *value) {
  ...
  return [((OrgJsoupHelperHttpConnection_KeyVal *) nil_chk([create_OrgJsoupHelperHttpConnection_KeyVal_init() keyWithNSString:key])) valueWithNSString:value];
}
...
OrgJsoupHelperHttpConnection_KeyVal *OrgJsoupHelperHttpConnection_KeyVal_createWithNSString_withNSString_withJavaIoInputStream_(NSString *key, NSString *filename, JavaIoInputStream *stream) {
  OrgJsoupHelperHttpConnection_KeyVal_initialize();
  return [((OrgJsoupHelperHttpConnection_KeyVal *) nil_chk([((OrgJsoupHelperHttpConnection_KeyVal *) nil_chk([create_OrgJsoupHelperHttpConnection_KeyVal_init() keyWithNSString:key])) valueWithNSString:filename])) inputStreamWithJavaIoInputStream:stream];
}
