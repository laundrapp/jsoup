...
void OrgJsoupHelperValidate_notNullWithId_(id obj) {
  ...
  if (obj == nil) @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Object must not be null");
}

void OrgJsoupHelperValidate_notNullWithId_withNSString_(id obj, NSString *msg) {
  OrgJsoupHelperValidate_initialize();
  if (obj == nil) @throw create_JavaLangIllegalArgumentException_initWithNSString_(msg);
}

void OrgJsoupHelperValidate_isTrueWithBoolean_(jboolean val) {
  OrgJsoupHelperValidate_initialize();
  if (!val) @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Must be true");
}

void OrgJsoupHelperValidate_isTrueWithBoolean_withNSString_(jboolean val, NSString *msg) {
  OrgJsoupHelperValidate_initialize();
  if (!val) @throw create_JavaLangIllegalArgumentException_initWithNSString_(msg);
}

void OrgJsoupHelperValidate_isFalseWithBoolean_(jboolean val) {
  OrgJsoupHelperValidate_initialize();
  if (val) @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Must be false");
}
...
void OrgJsoupHelperValidate_notEmptyWithNSString_(NSString *string) {
  OrgJsoupHelperValidate_initialize();
  if (string == nil || [string java_length] == 0) @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"String must not be empty");
}

void OrgJsoupHelperValidate_notEmptyWithNSString_withNSString_(NSString *string, NSString *msg) {
  OrgJsoupHelperValidate_initialize();
  if (string == nil || [string java_length] == 0) @throw create_JavaLangIllegalArgumentException_initWithNSString_(msg);
}
